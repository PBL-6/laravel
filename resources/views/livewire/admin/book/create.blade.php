                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div wire:loading wire:target="generateCategory" class="mt-1">
                                        Generating category...
                                    </div>
                                </div>
                                <div class="mb-5">
                                ...
                                <div class="mb-3">
                                    <button class="btn rounded-3 w-100" type="submit" style="background-color: #008797; color: white;">Add Book</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
{{--                @enderror--}}
{{--                <br><br>--}}
{{--                <input type="text" wire:model.live="title" placeholder="Title" size="50">--}}
{{--                @error('title')--}}
{{--                {{$message}}--}}
{{--                @enderror--}}
